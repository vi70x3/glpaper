...
static void nop_global_remove(void* data, struct wl_registry* registry, uint32_t name) {
	(void) data;
	(void) registry;
	(void) name;
}

static void nop_xdg_output_v1_description(void* data, struct zxdg_output_v1* xdg_output, const char* description) {
	(void) data;
	(void) xdg_output;
	(void) description;
}

static void nop_xdg_output_v1_done(void* data, struct zxdg_output_v1* xdg_output) {
	(void) data;
	(void) xdg_output;
}

static void nop_xdg_output_v1_logical_position(void* data, struct zxdg_output_v1* xdg_output, int32_t x, int32_t y) {
	(void) data;
	(void) xdg_output;
	(void) x;
	(void) y;
...
static void nop_xdg_output_v1_logical_size(void* data, struct zxdg_output_v1* xdg_output, int32_t width, int32_t height) {
	(void) data;
	(void) xdg_output;
	(void) width;
	(void) height;
...
static void nop_wl_output_done(void* data, struct wl_output* output) {
	(void) data;
	(void) output;
}

static void nop_wl_output_geometry(void* data, struct wl_output* output, int32_t x, int32_t y, int32_t pw, int32_t ph, int32_t subpixel, const char* make, const char* model, int32_t transform) {
	(void) data;
	(void) output;
	(void) x;
	(void) y;
...
static void nop_wl_output_scale(void* data, struct wl_output* output, int32_t factor) {
	(void) data;
	(void) output;
	(void) factor;
}

static void nop_wl_output_name(void* data, struct wl_output* output, const char* name) {
	(void) data;
	(void) output;
	(void) name;
}

static void nop_wl_output_description(void* data, struct wl_output* output, const char* description) {
	(void) data;
	(void) output;
	(void) description;
}

static void nop_layer_surface_v1_closed(void* data, struct zwlr_layer_surface_v1* surface) {
	(void) data;
	(void) surface;
}
...
void paper_init(char* _monitor, char* frag_path, uint16_t fps, char* layer_name, uint16_t width, uint16_t height) {
	...
	struct wl_registry_listener reg_listener = {
		...
		.global_remove = nop_global_remove
	};
	...
	wl_list_for_each(node, &outputs, link) {
		...
		struct zxdg_output_v1_listener xdg_listener = {
			.description = nop_xdg_output_v1_description,
			.done = nop_xdg_output_v1_done,
			.logical_position = nop_xdg_output_v1_logical_position,
			.logical_size = nop_xdg_output_v1_logical_size,
			.name = get_name
		};
		zxdg_output_v1_add_listener(xdg_output, &xdg_listener, node);

		struct wl_output_listener out_listener = {
			.done = nop_wl_output_done,
			.geometry = nop_wl_output_geometry,
			.mode = get_res,
			.scale = nop_wl_output_scale,
			.name = nop_wl_output_name,
			.description = nop_wl_output_description
		};
	...
	struct zwlr_layer_surface_v1_listener surface_listener = {
		.closed = nop_layer_surface_v1_closed,
